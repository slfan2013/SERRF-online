      ...
      complete: function(results) {
        ...
        if(num_error==0){
          ...
          var time = new Date;
            ...
            // put the project to the database
          ...
          $("#apply").click(function() {
            ...
            f.get("queue", {
              ...
              $("#applyText").html("<span class=\"rainbow\"><i  class=\"fa fa-spinner fa-spin\" ></i>. There are "+queue.queue_id.length+" jobs ahead of you. Please be patient. If failed, error message will pop-up.</span>");
